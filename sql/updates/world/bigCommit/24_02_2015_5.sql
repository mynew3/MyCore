...
UPDATE `creature_template` SET `ScriptName` = 'EC_npc_halloween_orphan_matron' WHERE `entry` IN (24519, 23973);
UPDATE `creature_template` SET `ScriptName` = 'EC_npc_shade_horseman' WHERE `entry` = 23543;
