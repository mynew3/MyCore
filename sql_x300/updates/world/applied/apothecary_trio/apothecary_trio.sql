...
UPDATE `creature_template` SET `AIName`='',`ScriptName`='EC_npc_apothecary_frye' WHERE `entry`=@NPC_FRYE;
UPDATE `creature_template` SET `AIName`='',`ScriptName`='EC_npc_apothecary_hummel' WHERE `entry`=@NPC_HUMMEL;
UPDATE `creature_template` SET `AIName`='',`ScriptName`='EC_npc_apothecary_baxter' WHERE `entry`=@NPC_BAXTER;
UPDATE `creature_template` SET `AIName`='',`ScriptName`='EC_npc_crazed_apothecary' WHERE `entry`=@NPC_CRAZED;
