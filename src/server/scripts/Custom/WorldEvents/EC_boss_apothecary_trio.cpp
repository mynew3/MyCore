...
class EC_npc_apothecary_hummel : public CreatureScript
{
    public:
        EC_npc_apothecary_hummel() : CreatureScript("EC_npc_apothecary_hummel") { }
        ...
        struct EC_npc_apothecary_hummelAI : public ScriptedAI
        {
            EC_npc_apothecary_hummelAI(Creature* creature) : ScriptedAI(creature), _summons(me)
            {
        ...
        {
            return new EC_npc_apothecary_hummelAI(creature);
        }
};

/*######
## EC_apothecary baxter
######*/

class EC_npc_apothecary_baxter : public CreatureScript
{
    public:
        EC_npc_apothecary_baxter() : CreatureScript("EC_npc_apothecary_baxter") { }

        struct EC_npc_apothecary_baxterAI : public ScriptedAI
        {
            EC_npc_apothecary_baxterAI(Creature* creature) : ScriptedAI(creature)
            {
                _instance = creature->GetInstanceScript();
            }
        ...
        CreatureAI* GetAI(Creature* creature) const
        {
            return new EC_npc_apothecary_baxterAI(creature);
        }
};
...
class EC_npc_apothecary_frye : public CreatureScript
{
    public:
        EC_npc_apothecary_frye() : CreatureScript("EC_npc_apothecary_frye") { }

        struct EC_npc_apothecary_fryeAI : public ScriptedAI
        {
            EC_npc_apothecary_fryeAI(Creature* creature) : ScriptedAI(creature)
            {
                _instance = creature->GetInstanceScript();
            }
        ...
        CreatureAI* GetAI(Creature* creature) const
        {
            return new EC_npc_apothecary_fryeAI(creature);
        }
};

/*######
## EC_npc_crazed_apothecary
######*/

class EC_npc_crazed_apothecary : public CreatureScript
{
    public:
        EC_npc_crazed_apothecary() : CreatureScript("EC_npc_crazed_apothecary") { }

        struct EC_npc_crazed_apothecaryAI : public ScriptedAI
        {
            EC_npc_crazed_apothecaryAI(Creature* creature) : ScriptedAI(creature) { }
        ...
        CreatureAI* GetAI(Creature* creature) const
        {
            return new EC_npc_crazed_apothecaryAI(creature);
        }
};

void AddSC_EC_boss_apothecary_trio()
{
    new EC_npc_apothecary_hummel();
    new EC_npc_apothecary_baxter();
    new EC_npc_apothecary_frye();
    new EC_npc_crazed_apothecary();
}
