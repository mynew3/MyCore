...
class EC_item_water_bucket : public ItemScript
{
    public:

        EC_item_water_bucket() : ItemScript("EC_item_water_bucket") { }
...
class EC_npc_halloween_fire : public CreatureScript
{
public:
    EC_npc_halloween_fire() : CreatureScript("EC_npc_halloween_fire") { }


    struct EC_npc_halloween_fireAI : public ScriptedAI
    {
        EC_npc_halloween_fireAI(Creature* c) : ScriptedAI(c) {}
    ...
    {
        return new EC_npc_halloween_fireAI(creature);
    }
};
...
*/
class EC_npc_shade_horseman : public CreatureScript
{
public:
    EC_npc_shade_horseman() : CreatureScript("EC_npc_shade_horseman") { }


    struct EC_npc_shade_horsemanAI : public ScriptedAI
    {
        EC_npc_shade_horsemanAI(Creature* c) : ScriptedAI(c), fires(c) {}
    ...
    CreatureAI* GetAI(Creature* creature) const
    {
        return new EC_npc_shade_horsemanAI(creature);
    }
};

class EC_npc_halloween_orphan_matron : public CreatureScript
{
public:
    EC_npc_halloween_orphan_matron() : CreatureScript("EC_npc_halloween_orphan_matron") { }
...
{
    new EC_item_water_bucket();
    new EC_npc_halloween_fire();
    new EC_npc_shade_horseman();
    new EC_npc_halloween_orphan_matron();
}
