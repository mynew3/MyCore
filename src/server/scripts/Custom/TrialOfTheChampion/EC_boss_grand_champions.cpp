...
void EC_AggroAllPlayers(Creature* pTemp)
{
...
bool EC_GrandChampionsOutVehicle(Creature* me)
{
...
class EC_generic_vehicleAI_toc5 : public CreatureScript
{
    public:
        EC_generic_vehicleAI_toc5(): CreatureScript("EC_generic_vehicleAI_toc5") {}

    struct EC_generic_vehicleAI_toc5AI : public npc_escortAI
    {
        EC_generic_vehicleAI_toc5AI(Creature* creature) : npc_escortAI(creature)
        {
    ...
    {
        return GetECTrialOfTheChampionAI<EC_generic_vehicleAI_toc5AI>(creature);
    }
};

// Marshal Jacob Alerius && Mokra the Skullcrusher || Warrior
class EC_boss_warrior_toc5 : public CreatureScript
{
    public:
        EC_boss_warrior_toc5(): CreatureScript("EC_boss_warrior_toc5") {}

    struct EC_boss_warrior_toc5AI : public BossAI
    {
        EC_boss_warrior_toc5AI(Creature* creature) : BossAI(creature,BOSS_GRAND_CHAMPIONS)
        {
            instance = creature->GetInstanceScript();
        ...
        void UpdateAI(uint32 uiDiff) override
        {
            ...
            if (!bDone && EC_GrandChampionsOutVehicle(me))
            {
                bDone = true;
    ...
    CreatureAI* GetAI(Creature* creature) const
    {
        return GetECTrialOfTheChampionAI<EC_boss_warrior_toc5AI>(creature);
    }
};

// Ambrose Boltspark && Eressea Dawnsinger || Mage
class EC_boss_mage_toc5 : public CreatureScript
{
    public:
        EC_boss_mage_toc5(): CreatureScript("EC_boss_mage_toc5") {}

    struct EC_boss_mage_toc5AI : public BossAI
    {
        EC_boss_mage_toc5AI(Creature* creature) : BossAI(creature, BOSS_GRAND_CHAMPIONS)
        {
            instance = creature->GetInstanceScript();
    ...
    CreatureAI* GetAI(Creature* creature) const
    {
        return GetECTrialOfTheChampionAI<EC_boss_mage_toc5AI>(creature);
    };
};

// Colosos && Runok Wildmane || Shaman
class EC_boss_shaman_toc5 : public CreatureScript
{
    public:
        EC_boss_shaman_toc5(): CreatureScript("EC_boss_shaman_toc5") {}

    struct EC_boss_shaman_toc5AI : public BossAI
    {
        EC_boss_shaman_toc5AI(Creature* creature) : BossAI(creature,BOSS_GRAND_CHAMPIONS)
        {
            instance = creature->GetInstanceScript();
    ...
    CreatureAI* GetAI(Creature* creature) const
    {
        return GetECTrialOfTheChampionAI<EC_boss_shaman_toc5AI>(creature);
    }
};

// Jaelyne Evensong && Zul'tore || Hunter
class EC_boss_hunter_toc5 : public CreatureScript
{
    public:
        EC_boss_hunter_toc5(): CreatureScript("EC_boss_hunter_toc5") {}

    struct EC_boss_hunter_toc5AI : public BossAI
    {
        EC_boss_hunter_toc5AI(Creature* creature) : BossAI(creature, BOSS_GRAND_CHAMPIONS)
        {
            instance = creature->GetInstanceScript();
    ...
    CreatureAI* GetAI(Creature* creature) const
    {
        return GetECTrialOfTheChampionAI<EC_boss_hunter_toc5AI>(creature);
    }
};

// Lana Stouthammer Evensong && Deathstalker Visceri || Rogue
class EC_boss_rogue_toc5 : public CreatureScript
{
    public:
        EC_boss_rogue_toc5(): CreatureScript("EC_boss_rogue_toc5") {}

    struct EC_boss_rogue_toc5AI : public BossAI
    {
        EC_boss_rogue_toc5AI(Creature* creature) : BossAI(creature,BOSS_GRAND_CHAMPIONS)
        {
            instance = creature->GetInstanceScript();
    ...
    CreatureAI* GetAI(Creature* creature) const
    {
        return GetECTrialOfTheChampionAI<EC_boss_rogue_toc5AI>(creature);
    }
};

class EC_achievement_toc5_grand_champions : public AchievementCriteriaScript
{
    public:
        uint32 creature_entry;

        EC_achievement_toc5_grand_champions(const char* name, uint32 original_entry) : AchievementCriteriaScript(name) 
        {
...
{
    new EC_generic_vehicleAI_toc5();
    new EC_boss_warrior_toc5();
    new EC_boss_mage_toc5();
    new EC_boss_shaman_toc5();
    new EC_boss_hunter_toc5();
    new EC_boss_rogue_toc5();
    new EC_achievement_toc5_grand_champions("EC_achievement_toc5_champions_mokra", NPC_MOKRA);
    new EC_achievement_toc5_grand_champions("EC_achievement_toc5_champions_eressea", NPC_ERESSEA);
    new EC_achievement_toc5_grand_champions("EC_achievement_toc5_champions_runok", NPC_RUNOK);
    new EC_achievement_toc5_grand_champions("EC_achievement_toc5_champions_zultore", NPC_ZULTORE);
    new EC_achievement_toc5_grand_champions("EC_achievement_toc5_champions_visceri", NPC_VISCERI);
    new EC_achievement_toc5_grand_champions("EC_achievement_toc5_champions_alerius", NPC_JACOB);
    new EC_achievement_toc5_grand_champions("EC_achievement_toc5_champions_ambrose", NPC_AMBROSE);
    new EC_achievement_toc5_grand_champions("EC_achievement_toc5_champions_colosos", NPC_COLOSOS);
    new EC_achievement_toc5_grand_champions("EC_achievement_toc5_champions_jaelyne", NPC_JAELYNE);
    new EC_achievement_toc5_grand_champions("EC_achievement_toc5_champions_lana", NPC_LANA);
};