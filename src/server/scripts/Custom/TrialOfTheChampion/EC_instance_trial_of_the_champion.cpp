...
class EC_instance_trial_of_the_champion : public InstanceMapScript
{
public:
    EC_instance_trial_of_the_champion() : InstanceMapScript("EC_instance_trial_of_the_champion", 650) { }
...
{
    new EC_instance_trial_of_the_champion();
}
