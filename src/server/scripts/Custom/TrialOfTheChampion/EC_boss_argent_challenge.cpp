...
class EC_spell_eadric_hoj : public SpellScriptLoader
{
    public:
        EC_spell_eadric_hoj() : SpellScriptLoader("EC_spell_eadric_hoj") { }

        class EC_spell_eadric_hoj_SpellScript: public SpellScript
        {
            PrepareSpellScript(EC_spell_eadric_hoj_SpellScript);
            ...
            {
                OnHit += SpellHitFn(EC_spell_eadric_hoj_SpellScript::HandleOnHit);
            }
        };

        SpellScript* GetSpellScript() const
        {
            return new EC_spell_eadric_hoj_SpellScript();
        }
};


class EC_boss_eadric : public CreatureScript
{
    public:
        EC_boss_eadric(): CreatureScript("EC_boss_eadric") {}

    struct EC_boss_eadricAI : public BossAI
    {
        EC_boss_eadricAI(Creature* creature) : BossAI(creature, BOSS_ARGENT_CHALLENGE_E)
        {
    ...
    {
        return GetECTrialOfTheChampionAI<EC_boss_eadricAI>(creature);
    };
};

class EC_boss_paletress : public CreatureScript
{
    public:
        EC_boss_paletress(): CreatureScript("EC_boss_paletress") {}

    struct EC_boss_paletressAI : public BossAI
    {
        EC_boss_paletressAI(Creature* creature) : BossAI(creature, BOSS_ARGENT_CHALLENGE_P)
        {
            instance = creature->GetInstanceScript();
            hasBeenInCombat = false;
    ...
    CreatureAI* GetAI(Creature* creature) const
    {
        return GetECTrialOfTheChampionAI<EC_boss_paletressAI>(creature);
    };
};

class EC_npc_memory : public CreatureScript
{
    public:
        EC_npc_memory(): CreatureScript("EC_npc_memory") {}

    struct EC_npc_memoryAI : public ScriptedAI
    {
        EC_npc_memoryAI(Creature* creature) : ScriptedAI(creature) {}
    ...
    CreatureAI* GetAI(Creature* creature) const
    {
        return GetECTrialOfTheChampionAI<EC_npc_memoryAI>(creature);
    };
};

// THIS AI NEEDS MORE IMPROVEMENTS
class EC_npc_argent_soldier : public CreatureScript
{
    public:
        EC_npc_argent_soldier(): CreatureScript("EC_npc_argent_soldier") {}

    struct EC_npc_argent_soldierAI : public npc_escortAI
    {
        EC_npc_argent_soldierAI(Creature* creature) : npc_escortAI(creature)
        {
    ...
    CreatureAI* GetAI(Creature* creature) const
    {
        return GetECTrialOfTheChampionAI<EC_npc_argent_soldierAI>(creature);
    };
};
...
class EC_spell_gen_reflective_shield : public SpellScriptLoader
{
    public:
        EC_spell_gen_reflective_shield() : SpellScriptLoader("EC_spell_gen_reflective_shield") { }

        class EC_spell_gen_reflective_shield_AuraScript : public AuraScript
        {
            PrepareAuraScript(EC_spell_gen_reflective_shield_AuraScript);
            ...
            void Register()
            {
                 AfterEffectAbsorb += AuraEffectAbsorbFn(EC_spell_gen_reflective_shield_AuraScript::Trigger, EFFECT_0);
            }
        };

        AuraScript *GetAuraScript() const
        {
            return new EC_spell_gen_reflective_shield_AuraScript();
        }
};

class EC_achievement_toc5_argent_challenge : public AchievementCriteriaScript
{
    public:
        uint32 creature_entry;

        EC_achievement_toc5_argent_challenge(const char* name, uint32 original_entry) : AchievementCriteriaScript(name) {
...
class EC_achievement_toc5_argent_confessor : public AchievementCriteriaScript
{
    public:
        uint32 creature_entry;

        EC_achievement_toc5_argent_confessor(const char* name, uint32 original_entry) : AchievementCriteriaScript(name) 
        {
            creature_entry = original_entry;
        }
...
class EC_achievement_toc5_the_faceroller : public AchievementCriteriaScript
{
    public:
        EC_achievement_toc5_the_faceroller(const char* name) : AchievementCriteriaScript(name) {}
...
{
    new EC_boss_eadric();
    new EC_spell_eadric_hoj();
    new EC_boss_paletress();
    new EC_npc_memory();
    new EC_npc_argent_soldier();
    new EC_spell_gen_reflective_shield();
    new EC_achievement_toc5_argent_challenge("EC_achievement_toc5_paletress", NPC_PALETRESS);
    new EC_achievement_toc5_argent_challenge("EC_achievement_toc5_eadric", NPC_EADRIC);
    
    new EC_achievement_toc5_argent_confessor("EC_achivement_toc5_argent_confessor_hogger", MEMORY_HOGGER);
    new EC_achievement_toc5_argent_confessor("EC_achivement_toc5_argent_confessor_vancleef", MEMORY_VANCLEEF);
    new EC_achievement_toc5_argent_confessor("EC_achivement_toc5_argent_confessor_mutanus", MEMORY_MUTANUS);
    new EC_achievement_toc5_argent_confessor("EC_achivement_toc5_argent_confessor_herod", MEMORY_HEROD);
    new EC_achievement_toc5_argent_confessor("EC_achivement_toc5_argent_confessor_lucifron", MEMORY_LUCIFRON);
    new EC_achievement_toc5_argent_confessor("EC_achivement_toc5_argent_confessor_thunderaan", MEMORY_THUNDERAAN);
    new EC_achievement_toc5_argent_confessor("EC_achivement_toc5_argent_confessor_chromaggus", MEMORY_CHROMAGGUS);
    new EC_achievement_toc5_argent_confessor("EC_achivement_toc5_argent_confessor_hakkar", MEMORY_HAKKAR);
    new EC_achievement_toc5_argent_confessor("EC_achivement_toc5_argent_confessor_veknilash", MEMORY_VEKNILASH);
    new EC_achievement_toc5_argent_confessor("EC_achivement_toc5_argent_confessor_kalithresh", MEMORY_KALITHRESH);
    new EC_achievement_toc5_argent_confessor("EC_achivement_toc5_argent_confessor_malchezar", MEMORY_MALCHEZAAR);
    new EC_achievement_toc5_argent_confessor("EC_achivement_toc5_argent_confessor_gruul", MEMORY_GRUUL);
    new EC_achievement_toc5_argent_confessor("EC_achivement_toc5_argent_confessor_vashj", MEMORY_VASHJ);
    new EC_achievement_toc5_argent_confessor("EC_achivement_toc5_argent_confessor_archimonde", MEMORY_ARCHIMONDE);
    new EC_achievement_toc5_argent_confessor("EC_achivement_toc5_argent_confessor_illidan", MEMORY_ILLIDAN);
    new EC_achievement_toc5_argent_confessor("EC_achivement_toc5_argent_confessor_delrissa", MEMORY_DELRISSA);
    new EC_achievement_toc5_argent_confessor("EC_achivement_toc5_argent_confessor_muru", MEMORY_ENTROPIUS);
    new EC_achievement_toc5_argent_confessor("EC_achivement_toc5_argent_confessor_ingvar", MEMORY_INGVAR);
    new EC_achievement_toc5_argent_confessor("EC_achivement_toc5_argent_confessor_cyanigosa", MEMORY_CYANIGOSA);
    new EC_achievement_toc5_argent_confessor("EC_achivement_toc5_argent_confessor_eck", MEMORY_ECK);
    new EC_achievement_toc5_argent_confessor("EC_achivement_toc5_argent_confessor_onyxia", MEMORY_ONYXIA);
    new EC_achievement_toc5_argent_confessor("EC_achivement_toc5_argent_confessor_heigan", MEMORY_HEIGAN);
    new EC_achievement_toc5_argent_confessor("EC_achivement_toc5_argent_confessor_ignis", MEMORY_IGNIS);
    new EC_achievement_toc5_argent_confessor("EC_achivement_toc5_argent_confessor_vezax", MEMORY_VEZAX);
    new EC_achievement_toc5_argent_confessor("EC_achivement_toc5_argent_confessor_algalon", MEMORY_ALGALON);

    new EC_achievement_toc5_the_faceroller("EC_achievement_toc5_the_faceroller");
}
