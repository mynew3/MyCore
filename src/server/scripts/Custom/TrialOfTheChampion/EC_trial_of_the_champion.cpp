...
class EC_npc_herald_toc5 : public CreatureScript
{
    public:
        EC_npc_herald_toc5(): CreatureScript("EC_npc_herald_toc5") {}
    ...
    bool OnGossipSelect(Player* player, Creature* creature, uint32 /*sender*/, uint32 action) override
    {
        ...
        if (action == GOSSIP_ACTION_INFO_DEF+1)
        {
            ...
            CAST_AI(EC_npc_herald_toc5::EC_npc_herald_toc5AI, creature->AI())->StartEncounter();
        }
    ...
    struct EC_npc_herald_toc5AI : public ScriptedAI
    {
        EC_npc_herald_toc5AI(Creature *creature) : ScriptedAI(creature)
        {
    ...
    {
        return GetECTrialOfTheChampionAI<EC_npc_herald_toc5AI>(creature);
    };
};

void AddSC_EC_trial_of_the_champion()
{
    new EC_npc_herald_toc5();
}
