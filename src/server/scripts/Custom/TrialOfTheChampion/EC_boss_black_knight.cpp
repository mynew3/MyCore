...
class EC_boss_black_knight : public CreatureScript
{
public:
    EC_boss_black_knight() : CreatureScript("EC_boss_black_knight") { }

    struct EC_boss_black_knightAI : public ScriptedAI
    {
        EC_boss_black_knightAI(Creature* creature) : ScriptedAI(creature)
        {
    ...
    {
        return GetECTrialOfTheChampionAI<EC_boss_black_knightAI>(creature);
    }

};

class EC_npc_risen_ghoul : public CreatureScript
{
public:
    EC_npc_risen_ghoul() : CreatureScript("EC_npc_risen_ghoul") { }

    struct EC_npc_risen_ghoulAI : public ScriptedAI
    {
        EC_npc_risen_ghoulAI(Creature* creature) : ScriptedAI(creature) {}
    ...
    CreatureAI* GetAI(Creature* creature) const
    {
        return GetECTrialOfTheChampionAI<EC_npc_risen_ghoulAI>(creature);
    }
};

class EC_npc_risen_announcer : public CreatureScript
{
public:
    EC_npc_risen_announcer() : CreatureScript("EC_npc_risen_announcer") { }

    struct EC_npc_risen_announcerAI : public ScriptedAI
    {
        EC_npc_risen_announcerAI(Creature* creature) : ScriptedAI(creature) {
        me->setFaction(14);
        }
    ...
    CreatureAI* GetAI(Creature* creature) const
    {
        return GetECTrialOfTheChampionAI<EC_npc_risen_announcerAI>(creature);
    }
};

class EC_npc_black_knight_skeletal_gryphon : public CreatureScript
{
public:
    EC_npc_black_knight_skeletal_gryphon() : CreatureScript("EC_npc_black_knight_skeletal_gryphon") { }

    struct EC_npc_black_knight_skeletal_gryphonAI : public npc_escortAI
    {
        EC_npc_black_knight_skeletal_gryphonAI(Creature* creature) : npc_escortAI(creature)
        {
            Start(false, true);
            instance = creature->GetInstanceScript();
        }
    ...
    CreatureAI* GetAI(Creature* creature) const
    {
        return GetECTrialOfTheChampionAI<EC_npc_black_knight_skeletal_gryphonAI>(creature);
    }
};

class EC_achievement_ive_had_worse : public AchievementCriteriaScript
{
    public:
        EC_achievement_ive_had_worse() : AchievementCriteriaScript("EC_achievement_ive_had_worse")
        {
        }
...
{
    new EC_boss_black_knight();
    new EC_npc_risen_ghoul();
    new EC_npc_risen_announcer();
    new EC_npc_black_knight_skeletal_gryphon();
    new EC_achievement_ive_had_worse();
}
